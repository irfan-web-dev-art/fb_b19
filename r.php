    ...
    <div class="container-fluid min-vh-100 bg-light">
        ...
        <div class="container bg-light">
            <img class="d-block mx-auto" src="https://logohistory.net/wp-content/uploads/2022/10/Facebook-Logo-2019.png"
                width="200px" alt="">
            <form action="" class="mx-auto shadow col-xl-5 col-lg-6 col-md-7 col-sm-9 bg-white p-4">
                ...
                <input type="text" placeholder="Mobile number or email address" class="form-control my-3 p-2">
                <input type="text" placeholder="New password" class="form-control my-3 p-2">
                ...
                <button style="background-color: #36A420;white-space:no-wrap"
                    class="btn p-3-5 fw-semibold w-50 mx-auto d-block text-white my-3">
                    Create new account
                </button>
